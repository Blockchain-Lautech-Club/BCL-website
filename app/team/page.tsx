        ...
        <div className="flex min-h-screen flex-col">
            ...
            <main className="min-h-screen bg-gray-50">
                <section className="bg-gradient-to-br from-primary/10 via-accent/5 to-primary/5 py-12 sm:py-16">
                    <div className="max-w-4xl mx-auto px-2 sm:px-6 lg:px-4 text-center">
                    ...
                    <section className="container mt-4 mx-auto">
                        <div className="pb-3 px-4 mx-auto max-w-screen-xl text-center py-6 lg:px-6">
                            <div className="grid gap-10 grid-cols-2 md:grid-cols-4 lg:grid-cols-4 w-full justify-content-center">
                                {/* Johnadek */}
