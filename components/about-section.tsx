...
export function AboutSection() {
  ...
  return (
    <section className="py-3 sm:py-5 bg-gray-50">
      ...
      {/* TEAM SECTION */}
      <section className="container mt-4 mx-auto bg-white dark:bg-gray-900">
        <div className="pb-3 pt-6 px-4 mx-auto max-w-screen-xl text-center lg:py-3 lg:px-6">
          <div className="mx-auto mb-6 md:mb-10">
            <h2 className="text-center font-serif text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-4 sm:mb-6">Our Team</h2>
            <p className="font-light text-gray-600 sm:text-xl dark:text-gray-500">Our team is made up of passionate builders, innovators, and problem-solvers dedicated to exploring the endless various possibilities of blockchain technology.</p>
          </div>
          <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-4 w-full justify-content-center">
            {/* Johnadek */}
            <div className="text-center text-gray-500 dark:text-gray-400">
              ...
              <ul className="flex justify-center mt-2 space-x-4">
                <li>
                  <a href="https://x.com/@Johnadek_" className="text-[#00acee] hover:text-gray-900 dark:hover:text-white">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              ...
              <ul className="flex justify-center mt-2 space-x-4">
                <li>
                  <a href="https://x.com/@thelma_opurum" className="text-[#00acee] hover:text-gray-900 dark:hover:text-white">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                    </svg>
                  </a>
